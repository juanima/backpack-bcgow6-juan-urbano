...
func (m *MockRepository) FilterProduct(name, color, code string, id, stock int, price float64, publish *bool) ([]*domain.Product, error) {
        return nil, nil
}

func (m *MockRepository) Store(name, color, code string, stock int, price float64, publish *bool) (domain.Product, error) {
        if m.Error != "" {
...
func (m *MockRepository) Update(name, color, code string, id, stock int, price float64, publish *bool) (domain.Product, error) {
...
func (m *MockRepository) UpdateStock(id int, stock int) (domain.Product, error){
        return domain.Product{}, nil
}
